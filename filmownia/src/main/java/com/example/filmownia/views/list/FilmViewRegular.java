...
//
//@Route(value = "film-view-regular", layout = MainLayout.class)
//
//public class FilmViewRegular extends HorizontalLayout {
//
//
...
//
//
//    public FilmViewRegular(UzytkownikRepository urepo, KomentarzRepository repo, FilmRepository frepo) {
//        this.Krepo = repo;
//        this.Frepo = frepo;
//        this.Urepo = urepo;
...
//        dialog.add(new H2("Jeśli chcesz móc dodać komentarz zaloguj się"));
